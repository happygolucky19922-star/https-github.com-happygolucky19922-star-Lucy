...
import { 
  ...
  Phone, Video as VideoCall, Database, MessageSquare, Github
} from 'lucide-react';
    ...
    try {
      ...
      setMessages(prev => {
         ...
         if(!nw[nw.length - 1].content) {
            nw[nw.length - 1] = { ...nw[nw.length - 1], content: 'Error communicating with Lucy. Please check your API key.' };
         }
         return nw;
      });
    }
  ...
  return (
    <div className="h-full flex bg-[#050505] overflow-hidden text-white font-sans w-full relative">
      ...
      <div className="flex-1 flex flex-col relative w-full border-r border-white/5">
        {/* Header */}
        <header className="p-4 sm:p-6 border-b border-white/5 flex flex-wrap items-center justify-between gap-4 glass z-10 sticky top-0">
          ...
          <div className="flex flex-wrap items-center justify-end gap-3 flex-1 ml-4 py-2">
             ...
             <div className="flex flex-wrap items-center gap-1.5 overflow-x-auto custom-scrollbar pb-1 sm:pb-0 max-w-full">
             ...
             <div className="flex flex-wrap items-center gap-1.5 xl:border-r border-white/10 xl:pr-2 xl:mr-1">
                 <div className="flex bg-white/5 border border-white/10 rounded-lg p-0.5 overflow-hidden">
                 ...
                 <button onClick={() => notify('Executing Pre-Tune Analysis...')} className="flex px-3 py-1.5 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg text-[9px] font-black uppercase tracking-widest transition-all text-white items-center gap-1.5 whitespace-nowrap">
